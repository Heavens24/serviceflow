...
def get_cors_origins():
    ...
    Multiple origins may be supplied through CORS_ORIGINS
...
class Config:
    ...
    DEBUG = get_boolean_environment_value(
        "FLASK_DEBUG",
        default=FLASK_ENV == "development",
    )

    TESTING = get_boolean_environment_value(
        "TESTING",
        default=False,
    )
    ...
    JWT_ACCESS_TOKEN_EXPIRES = timedelta(
        hours=get_integer_environment_value(
    ...
    # ===========================================
    # PostgreSQL / Supabase / Render compatibility
    # ===========================================
